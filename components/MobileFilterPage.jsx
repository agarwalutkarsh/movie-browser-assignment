...
const MobileFilterPage = () => {
  ...
  const searchButtonHandler = () => {
    const startDate = moment(mainContext?.filterObject?.['primary_release_date.gte'] ?? '') // start date
    const endDate = moment(mainContext?.filterObject?.['primary_release_date.lte'] ?? '') // end date
    // Date Error Handling
